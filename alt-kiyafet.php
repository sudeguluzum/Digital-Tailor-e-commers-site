...
<head>
  ...
  <!-- 
    - custom css link
  -->
  <link rel="stylesheet" href="alt-kiyafet.css">
...
<body id="top">
  ...
  <section class="n-product">
    ...
    <div class="n-content">
      <?php
      $sql = "SELECT kiyafet_id, detay, fiyat FROM kiyafet where ktg_id = 2";
      $fire = mysqli_query($conn, $sql);

      while ($result = mysqli_fetch_assoc($fire)) :
      ?>
        <div class="row">
          <div class="row-img" id="a<?php echo $result['kiyafet_id']; ?>">
            <a href="kumaslar.php?id=<?= $result['kiyafet_id'] ?>"> <img src="img/alt/<?php echo $result['kiyafet_id']; ?>.png" alt="Alt<?php echo $result['kiyafet_id']; ?>"> </a>
          </div>
          <h3><?php echo $result['detay']; ?></h3>
              <div class="row-in">
                <div class="row-left">
                  <h6> <?php echo $result['fiyat'] . " TL"; ?>
                  </h6>
                </div>
                <div class="row-right">
