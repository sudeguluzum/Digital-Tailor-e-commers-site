...
<body>
    ...
    <section>
        ...
        <article>
            ...
            <div class="n-content">
                <?php
                $sql = "SELECT kiyafet_id, detay, fiyat FROM kiyafet";
                ...
                ?>
                    <div class="row">
                        <div class="row-img" id="u<?php echo $result['kiyafet_id']; ?>">
                            <img src="img/kiyafetler/<?php echo $result['kiyafet_id']; ?>.png" alt="Üst<?php echo $result['kiyafet_id']; ?>">
                        </div>
                        ...
                        <div class="tablo">
                            <form action="kiyafet-fiyat_guncelle.php" class="form" method="post">
                                <input type="hidden" name="kiyafet_id" value="<?php echo $result['kiyafet_id']; ?>">
